...
summary: 'testing, this blog is for testing purposes ONLY'
---
...
6. Lastly, in the app level build.gradle file (same file as above), find the applicationId and change it to the name you chose in step 2. 
...
I changed mine from com.example.mediumTutorial
